...
# Converts features.csv to hdf5 AND standardises features
...
# Remove the file_path column from features
features_df = df.drop(columns=['file_path'])
...
"""
Remove the following part if you do not have prior data to initialise.
"""
...
# Set up AMI code
calc = Simulation.from_template_folder(F"internal_workdir_{run_code}", "raspa_template")
